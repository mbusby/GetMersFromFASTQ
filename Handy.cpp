...
string Handy::getStringWithReplace(string haystack,  string needle, string newNeedle)
{

	std::size_t f = haystack.find(needle);
	
	if(f!=std::string::npos)
	{
		haystack.replace(f, needle.length(), newNeedle);
	}
